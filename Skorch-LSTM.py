...
class LstmNetwork(nn.Module):
    def __init__(self, n_features=17, n_lstm_hidden=20, n_out=1, num_layers=1, bi=False):
        super().__init__()
        self.n_features = n_features  # remember to change the number of features!
        self.n_lstm_hidden = n_lstm_hidden  # significant hyper parameter
        self.n_fc_hidden = n_lstm_hidden
        self.n_out = n_out
        self.num_layers = num_layers  # the number of lstm layers
        self.bi = bi
...
'''
#  random search for hyper parameters optimization
...
'''
# genetic algorithm Hyper parameter Search, very slow for LSTM
